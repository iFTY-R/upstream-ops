...
// 使用方法：
//
//	import _ "github.com/ifty-r/upstream-ops/backend/connector/newapi"
//	import _ "github.com/ifty-r/upstream-ops/backend/connector/sub2api"
//
...
// DefaultBrowserUserAgent avoids exposing the monitoring service identity to
// upstream edge security while keeping explicit per-deployment overrides possible.
const DefaultBrowserUserAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36"
